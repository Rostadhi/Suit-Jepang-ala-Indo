...
const endAlrt = document.querySelector("#peringatan-berakhir");
...
const container = document.querySelector("#hasil-kontainer");
      ...
      desc2Span[desc2Span.length - 1].ontransitionend = () => {
        ...
        desc2.addEventListener("animationend", () => {
          ...
          desc3Span[desc3Span.length - 1].ontransitionend = () => {
            const cta = document.querySelector("#weapon");
...
const myArray = ["Akik", "Prasasti", "Keris"];
...
function playRound(playerSelection, computerSelection) {
  ...
  if (computerSelection == playerSelection) {
    ...
    (computerSelection == "akik" && playerSelection == "keris") ||
    (computerSelection == "keris" && playerSelection == "prasasti") ||
    (computerSelection == "prasasti" && playerSelection == "akik")
  ) {
    ...
    if (computerScore === 1) {
      ...
      displayResults(
        `Arghh. ${capitalize(
          computerSelection
        )} beats ${playerSelection}. Ayo dicoba lagi!`
      );
    } else if (computerScore === 3) {
      displayResults(
        `${capitalize(
          computerSelection
        )} beats ${playerSelection}. Tidak apa-apa. Kamu pasti bisa!!`
      );
    } else if (computerScore === 4) {
      displayResults(
        `Oh tidak. Seri!! ${capitalize(
          computerSelection
        )} beats ${playerSelection}. Ayo lebih semangat lagi!`
      );
    } else {
    ...
    if (playerScore === 1) {
      ...
      displayResults(
        `Kamu pemain yang jago. ${capitalize(
          playerSelection
      ...
      displayResults(
        `${capitalize(
          playerSelection
        )} beats ${computerSelection}! Apakah kita bisa menang??`
      );
    } else if (playerScore === 4) {
      displayResults(
        `${capitalize(
          playerSelection
        )} beats ${computerSelection}. Satu lagi dan kamu menjadi pahlawan!`
      );
    } else {
...
function declareWinner() {
  ...
  if (playerScore > computerScore) {
    endDesc.textContent = "Kamu menang! Kamu berhasil mengusir penjajah!!";
    returnMainBtn.innerText = "Main Lagi";
  } else {
    endDesc.textContent = "Kamu kalah...mereka berhasil menjajah kamu?";
    returnMainBtn.innerText = "Coba lagi?";
  }
  fadeIn();
